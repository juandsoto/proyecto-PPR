...
function Select<T extends number | string>(props: SelectProps<T>) {
	return (
		<form className="max-w-sm">
			...
			<select id={ props.id } className="bg-transparent border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
